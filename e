...
VERSION="2025-08-30-ui8-table+clean-menu-v2-patch1"
...
install_apk_interactive() {
  local apkfile="$1"
  if command -v termux-open >/dev/null 2>&1; then termux-open "$apkfile" >/devnull 2>&1 && return 0; fi
